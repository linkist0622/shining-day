...
現行のキャラクター・青と白の配色・スクロールの物語を継承した、静的サイトです。HTML/CSS/JavaScriptを配信し、Viteは開発時だけ使います。

## 公開するページ

- `dist/index.html` — 思想、日常、藤澤節子、この家の前史、受け継ぐ運営。
- `dist/guide/index.html` — ご本人・ご家族・ケアマネジャー向けの案内ページ。
...
- 本番サイトは https://shining-day.com/ です。開設・受付は準備中の表示を維持しています。

GitHubの `main` がVercelの本番公開元です。確認用の `codex/trust-preview-20260916` とSitesのプレビューは別管理です。今回の承認済み改修（トップコピー、相談・地域の前史・運営案内、モバイルの星マーク）を本番に反映しています。
